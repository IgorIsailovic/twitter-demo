...
public class TweetControllerTest {
	...
	@Test
	public void deleteTweetWrongUrl() throws Exception {

		String wrongUrl = "tweeets";

		MockHttpServletRequestBuilder mockRequest = MockMvcRequestBuilders
				.delete("/v1/" + wrongUrl + tweet2.getTweetId()).contentType(MediaType.APPLICATION_JSON)
				.accept(MediaType.APPLICATION_JSON).header("X-Username", "sbg_user1")
				.content(this.mapper.writeValueAsString(tweet1)
	...
	@Test
	public void deleteTweetTooManyParams() throws Exception {
